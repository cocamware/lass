...
#ifndef LASS_GUARDIAN_OF_INCLUSION_CONFIG_COMPILER_SUNPRO_H
#define LASS_GUARDIAN_OF_INCLUSION_CONFIG_COMPILER_SUNPRO_H

#define LASS_COMPILER_VERSION __SUNPRO_CC
