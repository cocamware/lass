...
#if (LASS_COMPILER_TYPE == LASS_COMPILER_TYPE_MSVC) && (LASS_ADDRESS_SIZE == 32)
#	include "atomic_msvc_x86.h"
#elif (LASS_COMPILER_TYPE == LASS_COMPILER_TYPE_MSVC) && (LASS_ADDRESS_SIZE == 64)
