...
RemoteExceptionBase::~RemoteExceptionBase() 
{
}

void RemoteExceptionBase::throwSelf() const 
{ 
	doThrowSelf(); 
}
...
::std::auto_ptr<RemoteExceptionBase> Exception::doClone() const
{
	return ::std::auto_ptr<RemoteExceptionBase>(new Exception(*this));
}
