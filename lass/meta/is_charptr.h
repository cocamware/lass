...
#ifndef LASS_GUARDIAN_OF_INCLUSION_META_IS_CHARPTR_H
#define LASS_GUARDIAN_OF_INCLUSION_META_IS_CHARPTR_H
...
namespace impl
{
struct IsCharPtrTester
{
	static lass::meta::True test(char *);
	static lass::meta::True test(const char *);
	static lass::meta::False test(...);
};
template<int value>
