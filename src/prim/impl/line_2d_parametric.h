...
/** @class lass::prim::impl::Line2DParametric
 *  @brief implementation of 2d line with parametric equation.
 *  @author Bram de Greve [BdG]
 */



#ifndef LASS_GUARDIAN_OF_INCLUSION_PRIM_IMPL_LINE_2D_PARAMETRIC_H
#define LASS_GUARDIAN_OF_INCLUSION_PRIM_IMPL_LINE_2D_PARAMETRIC_H
...
#include "line_2d_parametric.inl"
