...
/** @class lass::io::XmlOStream
 *  @brief Output stream for writing a selection of geometric primitives to XML files.
 */



#ifndef LASS_GUARDIAN_OF_INCLUSION_IO_XML_O_STREAM_H
#define LASS_GUARDIAN_OF_INCLUSION_IO_XML_O_STREAM_H
