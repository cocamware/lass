...
<
    ...
    template <class> class ObjectTraits
>
void QuadTree< ObjectType, ObjectTraits >::add(const ObjectType& iObject,int iMaxSize = 100, int iMaxLevel = 10)
{
...
<
    ...
    template <class> class ObjectTraits
>
typename QuadTree< ObjectType, ObjectTraits >::QuadNode* QuadTree< ObjectType, ObjectTraits >::QuadNode::add(const ObjectType& iObject,int iMaxSize = 100, int iMaxLevel = 10)
{
	if (leaf)
	{
