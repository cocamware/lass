...
/** @class lass::meta::Type2Type
 *  @brief encapsulates a type in another type
...
#ifndef LASS_GUARDIAN_OF_INCLUSION_META_TYPE_2_TYPE_H
#define LASS_GUARDIAN_OF_INCLUSION_META_TYPE_2_TYPE_H
