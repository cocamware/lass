 ...
 *  The lasslass::meta Library, Copyright (c) 2001 by Andrei Alexandrescu\n
 *  This code (lasslass::meta) accompanies the book:\n
 *  Alexandrescu, Andrei. "Modern C++ Design: Generic Programming and Design Patterns Applied". 
 *  Copyright (c) 2001. Addison-Wesley.\n
 *  Permission to use, copy, modify, distribute and sell this software (lasslass::meta) for any purpose is 
 ...
 *  software (lasslass::meta) for any purpose. It is provided "as is" without express or implied warranty.\n
 */
