...
/** @class lass::meta::Int2Type
 *  @brief encapsulates an integer value in a type
...
#ifndef LASS_GUARDIAN_OF_INCLUSION_META_INT_2_TYPE_H
#define LASS_GUARDIAN_OF_INCLUSION_META_INT_2_TYPE_H
