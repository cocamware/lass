...
Iterator next(Iterator iIterator)
{
	return ++iIterator;
}
 ...
 */
template <typename Iterator>
Iterator prior(Iterator iIterator)
{
	return --iIterator;
}
...
Iterator next(Iterator iIterator, Distance iDistance)
{
 ...
 */
template <typename Iterator, typename Distance>
Iterator prior(Iterator iIterator, Distance iDistance)
{
	std::advance(iIterator, -iDistance);
	return iIterator;
}
