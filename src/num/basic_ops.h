...
template <typename T> inline T log2(const T& iV);
template <typename T> inline T log10(const T& iV);
...
template <typename T> inline void inplog2(T& ioV);
template <typename T> inline void inplog10(T& ioV);
...
inline float log2(float iV);
inline float log10(float iV);
...
inline double log2(double iV);
inline double log10(double iV);
...
inline long double log2(long double iV);
inline long double log10(long double iV);
...
template <typename T> inline std::complex<T> log2(const std::complex<T>& iV);
template <typename T> inline std::complex<T> log10(const std::complex<T>& iV);
