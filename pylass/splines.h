...
#ifndef PYLASS_GUARDIAN_OF_INCLUSION_SPLINES_H
#define PYLASS_GUARDIAN_OF_INCLUSION_SPLINES_H
...
class SplineLinear: public python::PyObjectPlus
{
	PY_HEADER(python::PyObjectPlus)
public:
	typedef std::vector<double> TSequence;
	typedef std::vector< std::pair<double, double> > TPairSequence;
	SplineLinear() {}
...
class SplineCubic: public python::PyObjectPlus
{
	PY_HEADER(python::PyObjectPlus)
public:
	typedef std::vector<double> TSequence;
